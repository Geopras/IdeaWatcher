...
gulp.task('buildhtml', function () {
    ...
    return gulp.src([
        ...
        '../dev/view/html/hotIdeaList-view.html',
        '../dev/view/html/freshIdeaList-view.html',
        '../dev/view/html/trendingIdeaList-view.html',
        '../dev/view/html/categoryIdeaList-view.html',
