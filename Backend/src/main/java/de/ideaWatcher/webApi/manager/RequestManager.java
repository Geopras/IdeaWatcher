...
//        this.workflowMapping.addCommand("SIdeaDetails/deleteIdeaRequest",
//                new DeleteIdeaCommand());
        ...
        this.workflowMapping.addCommand("SIdeaCreation/saveIdeaRequest",
                new AddIdeaCommand());
        this.workflowMapping.addCommand("SIdeaCreation/getIdeaToEditRequest",
     ...
     *
     * @param request
     *            {String} Request als JSON-String
